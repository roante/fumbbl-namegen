...
// http://fumbbl.com/xml:roster?id=[1-16]
...
function generateOrcName() {
	...
	return randomArrayElement(names) + " " + randomArrayElement(foods) + "-" + randomArrayElement(eatingStyles);
}

if (isAmazonTeam()) {
	return generateAmazonName();
} else if if (isChaosTeam()) {
	return generateChaosName();
} else if if (isChaosDwarfTeam()) {
	return generateChaosDwarfName();
} else if if (isChaosPactTeam()) {
	return generateChaosPactName();
} else if if (isDarkElfTeam()) {
	return generateDarkElfName();
} else if if (isDwarfTeam()) {
	return generateDwarfName();
} else if if (isElfTeam()) {
	return generateElfName();
} else if if (isGoblinTeam()) {
	return generateGoblinName();
} else if if (isHalflingTeam()) {
	return generateHalflingName();
} else if if (isHighElfTeam()) {
	return generateHighElfName();
} else if if (isHumanTeam()) {
	return generateHumanName();
} else if if (isKhemriTeam()) {
	return generateKhemriName();
} else if if (isLizardmenTeam()) {
	return generateLizardmenName();
} else if if (isNecromanticTeam()) {
	return generateNecromanticName();
} else if if (isNorseTeam()) {
	return generateNorseName();
} else if if (isNurgleTeam()) {
	return generateNurgleName();
} else if if (isOgreTeam()) {
	return generateOgreName();
} else if (isOrcTeam()) {
	setName(generateOrcName());
} else if if (isSkavenTeam()) {
	return generateName();
} else if if (isSlannTeam()) {
	return generateSlannName();
} else if if (isUndeadTeam()) {
	return generateUndeadName();
} else if if (isUnderworldTeam()) {
	return generateUnderworldName();
} else if if (isVampireTeam()) {
	return generateName();
} else {
	setName("???");
}
